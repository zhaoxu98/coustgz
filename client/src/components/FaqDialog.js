            ...
            <Dialog title="FAQ" actions={dialogActions}>
                <div className={styles.faq}>
                    <p>
                        ...
                        <strong>A:</strong> No, data have to be manually updated by running <a rel="noopener noreferrer" target="_blank" href="//http://159.75.181.10/json/mkdata.php">this page</a> to obtain and save data from <a rel="noopener noreferrer" target="_blank" href="https://w5.hkust-gz.edu.cn/wcq/cgi-bin/">HKUST(GZ) Class Schedule and Quota</a> by crawling and parsing the website, i.e. data are correct up to the latest time of running the data retrieving page.<br />
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>GitHub:</strong> <a rel="noopener noreferrer" target="_blank" href="https://github.com/zhaoxu98/CoUSTGZ">https://github.com/zhaoxu98/CoUSTGZ</a><br />
                    </p>
                    <p>
